...
/**
 * Jetpack Compose PlayGround dropdown menu button with included trailing icon as well as text label and item
 * content slots.
 *
...
fun <T> JPGDropdownMenuButton(
    ...
    Box(modifier = modifier) {
        JPGOutlinedButton(
            ...
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) JPGIcons.ArrowDropUp else JPGIcons.ArrowDropDown,
...
/**
 * Jetpack Compose Playground dropdown menu with item content slots. Wraps Material 3 [DropdownMenu] and
 * [DropdownMenuItem].
 *
